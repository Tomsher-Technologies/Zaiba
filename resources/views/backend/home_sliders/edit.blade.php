                ...
                <div class="card-body">
                    <form class="form-horizontal" method="POST" action="{{ route('home-slider.update', $homeSlider) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="Title" value="{{ old('title', $homeSlider->title) }}" id="title"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="Sub Title" value="{{ old('sub_title', $homeSlider->sub_title) }}" id="sub_title"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="Button Text" value="{{ old('btn_text', $homeSlider->btn_text) }}" id="btn_text"
